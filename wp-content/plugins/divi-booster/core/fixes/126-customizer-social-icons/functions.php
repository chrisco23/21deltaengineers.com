...
?>
    ...
    $wp_customize->add_setting(
        'wtfdivi[fixes][126-customizer-social-icons][icons]',
        array(
            'type' => 'option',
            'transport' => 'refresh',
...
function db121_get_icons() {
    ...
    if (count($icons) == 1) {
        return array();
    } // Only have the icon template, no actual icons
    return $icons;
}
...
function db121_improve_customizer_warning() {
    ...
    ?>
        <style>
            .et-social-icon>a.customize-unpreviewable {
