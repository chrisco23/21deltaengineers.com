...
namespace DiviBooster\GalleryBooster\LightboxCloseButtonStyles;
...
function add_advanced_fields($fields, $slug, $main_css_element) {
    ...
    $fields['fonts']['dbdb_lightbox_close_button'] = array(
        'label'      => esc_html__('Lightbox Close Button', 'divi-booster'),
        'css'        => array(
            'main'       => "{$order_class}_dbdb_lightbox_open .mfp-gallery .mfp-close",
            'hover'      => "{$order_class}_dbdb_lightbox_open .mfp-gallery .mfp-close:hover",
            'text_shadow' => "{$order_class}_dbdb_lightbox_open .mfp-gallery .mfp-close",
            'important' => array(
                'text_shadow'
            )
        ),
