...
>
    ...
    >
        ...
        <span class="iawp-label"><?php
            esc_html_e('Edit Columns', 'independent-analytics'); ?></span>
    </button>
    ...
    >
        <div class="modal-inner">
            <div class="title-small">
                <?php
                esc_html_e('Columns', 'independent-analytics'); ?>
            </div>
            <?php
            foreach ($columns as $column): ?>
                ...
                >
                    ...
                    echo esc_attr($column->id()); ?>"
                        <?php
                        if ($column->requires_woocommerce() && (iawp_is_free(
                                                                ) || ! iawp_using_woocommerce(
                                ))): ?>
                            <?php
