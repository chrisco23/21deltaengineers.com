	...
	public function get_message(): array {
		return [
			...
			'<em>' . implode(
				...
				[
					...
					/* translators: %1$s: setting name, %2$s: setting name, %3$s: home URL */
						__( 'I would like to disable %1$s (or %2$s) for static content files like .jpg, .jpeg, .png, .gif and .webp on my website - %3$s. These files should have been handled by Apache server instead of Nginx.', 'webp-converter-for-media' ),
			...
			/* translators: %1$s: open strong tag, %2$s: close strong tag, %3$s: field value, %4$s: field label, %5$s: open anchor tag, %6$s: close anchor tag */
				__( '%1$sAn alternative solution to avoid this problem%2$s may be to set the %3$s option for the %4$s field in %5$sthe Advanced Settings tab%6$s.', 'webp-converter-for-media' ),
