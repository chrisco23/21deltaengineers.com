...
class Licensing {
    ...
    function dbal_license_page() {
        add_filter("db-settings-{$this->plugin_slug}-active-tab", function () {
            return 'updates';
        });
...
?>
                                ...
                                <tr valign="top">
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <p>Enter your license key to enable updates.</p>
                                            <p>You can get your license key from your <a href="https://divibooster.com/your-account/" target="_blank">Divi Booster account</a>, or <a href="<?php esc_attr_e($this->plugin_url); ?>" target="_blank">purchase a license</a>.</p>
                                        <?php } ?>
                                    </td>
                                </tr>
                            </tbody>
        ...
        function dbal_admin_notices() {
            ...
            if (empty($_GET['plugin']) || $_GET['plugin'] !== $this->plugin_slug) {
                return;
            }
            ...
            <tr class="plugin-update-tr active">
                <td colspan="4" class="plugin-update colspanchange">
                    <div class="update-message notice inline notice-warning notice-alt">
                        <p>Enter your license key on the <a href="<?php esc_attr_e($settings_url); ?>">settings page</a> to enable updates. You can get your license from your <a href="https://divibooster.com/your-account/purchase-history/" target="_blank">Divi Booster account</a>, or <a href="<?php esc_attr_e($this->plugin_url); ?>" target="_blank">purchase a license</a>.</p>
                    </div>
                </td>
            </tr>
        <?php
